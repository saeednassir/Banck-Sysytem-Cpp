...
private:
    ...
    static short _ReadMaimMenueOption()
    {
        cout << setw(37) << left << "" << "Choose what do you want to do? [1 to 10]? ";
        short Chioce = clsInputValidate::ReadNumberBetween<short>(1, 10, "Enter Number between 1 to 10? ");
        return Chioce;
    }
...
public:
    ...
    static void ShowMainMenue()
    {
        ...
        _PerfromMainMenueOption((enMainMenueOptions)_ReadMaimMenueOption());
